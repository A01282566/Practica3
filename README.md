...
In conclusion, it can be said that the spiderwebs or white lines help us to make the connections and select the correct components, as there can be many of the same, for example, a lot of 470 resistances which have their respective place. Another tool that was useful was the one that delimitated the circuit board frame, as it could be measured in order to cut it in the right way. In my experience, what I couln't understand first was how the lines worked, as some elements needed to be rotated. Another problem that I had was that I thought that I connected everything, but then, when I used the tool to verify it, some things weren't connected, so it is very useful. One suggestion to the laboratory practice instructions is that it would be great if an example or screenshots of how the 3d view should look like and also, how the gerber files should look like in the PCB gogo webpage.
